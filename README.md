...
Kết luận ngắn: ElevenLabs cho chất lượng transcript rất mạnh trên 980 file đã score, tốt hơn OpenAI về WER/CER trong phần partial này. Tuy nhiên free quota hết giữa run, nên chưa đủ căn cứ thay OpenAI làm model chính cho full pipeline.
